...
<body>
  <div class="header">
    ...
    <div class="brand">Pro<span class="brand-accent">Hands</span></div>
  </div>
  <h1>${title}</h1>
  ${content}
  
  <div class="footer">
    © ${new Date().getFullYear()} ProHands. All rights reserved.
  </div>
</body>
</html>
`;
...
<p>These terms and conditions (“Terms”) govern the use of services made available on or through https://prohands.com/ and/or the PROHANDS mobile app (collectively, the “Platform”, and together with the services made available on or through the Platform, the “Services”).</p>
...
<p>The Terms constitute a binding and enforceable legal contract between PROHANDS LLP (a company incorporated under the Companies Act, 2013 with its registered address (“PROHANDS”, “we”, “us”, or “our”), and you, a user of the Services, or any legal entity that books Pro Services (defined below) on behalf of end-users (“you” or “Customer”).</p>
...
<h2>1. SERVICES</h2>
<p>The Services include the provision of the Platform that enables you to arrange and schedule different home-based services with independent third-party service providers of those services (“Service Professionals”). As a part of the Services, PROHANDS facilitates the transfer of payments to Service Professionals for the services they render to you and collects payments on behalf of such Service Professionals.</p>
<p>The services rendered by Service Professionals are referred to as “Pro Services”. The term “Services” does not include the Pro Services. Prohands does not provide the Pro Services and is not responsible for their provision. Service Professionals are solely liable and responsible for the Pro Services that they offer or otherwise provide through the Platform. PROHANDS and its affiliates do not employ Service Professionals, nor are Service Professionals agents, contractors, or partners of PROHANDS or its affiliates. Service Professionals do not have the ability to bind or represent PROHANDS.</p>
<p>The Platform is for your personal and non-commercial use only, unless otherwise agreed upon in accordance with the terms of a separate agreement. Please note that the Platform is intended for use only within India. You agree that in the event you avail the Services or Pro Services from a legal jurisdiction other than the territory of India, you will be deemed to have accepted the PROHANDS terms and conditions applicable to that jurisdiction.</p>
<p>The Services are made available under various brands owned by or otherwise licensed to PROHANDS and its affiliates.</p>
<p>A key part of the Services is PROHANDS ability to send you text messages, electronic mails, or WhatsApp messages, including in connection with your bookings, your utilisation of the Services, or as a part of its promotional and marketing strategies. While you may opt out of receiving these text messages by contacting PROHANDS service@prohands.com or through the in-Platform settings, you agree and acknowledge that this may impact PROHANDS ability to provide the Services (or a part of the Services) to you.</p>
...
<p><strong>PROHANDS promotional code:</strong></p>
<p>PROHANDS may, in its sole discretion, offer promotional codes that may be redeemed for, other features or benefits related to the Services, and/or Pro Services, subject to any additional terms that may apply on a promotional code.</p>
<p>You agree that (i) you shall use Code in a lawful manner, and only for the purposes specified by such Code, (ii) you shall not duplicate, sell, or transfer the Codes in any manner (including by posting such codes on a public forum) unless you ha PROHANDS express prior consent to do so, (iii) Code may be disabled by PROHANDS at any time for any reason without any liability to you, (iv) Codes are not valid for cash, and (v) Codes may expire prior to your use.</p>
<p>PROHANDS may, at its sole discretion, provide only certain users with Codes that may result in different amounts charged for the same or similar services obtained by other users.</p>
<p>PROHANDS reserves the right to withhold or deduct Codes or other features or benefits obtained through the use of Codes, by you or any other user, if PROHANDS reasonably determines or believes that the use or redemption of the Codes was in error, fraudulent, illegal, or in violation of the applicable Coids terms or these Terms.</p>
...
<p>You agree and acknowledge that PROHANDS may, without notice to you, remove, or otherwise restrict access to User Content that, in its sole discretion, violates these Terms.</p>
...
<p><strong>Cancellations:</strong> Bookings that are cancelled before confirmation on the Platform will not be charged. PROHANDS cancellation policy sets out applicable cancellation fees.</p>
...
<p>Prohands reserves the right to charge you for the different Services you may avail and/or for any other facilities you may opt for, from time to time, on or via the Platform.</p>
<p><strong>Charges and Fees in respect of Pro Services:</strong></p>
<p>In respect of Pro Services that you seek to avail through the Platform, you shall be required to pay Service Professionals the amount indicated at the time of booking as well as amounts towards (a) any additional Pro Services you may avail, (b) out of pocket expenses incurred by the Service Professional, and (c) expenses arising out of the purchase of goods required or utilised for the performance of the Pro Service (“Charges”). In addition to the Charges payable to Service Professionals, PROHANDS reserves the right to charge you a convenience fee for facilitating the booking and transferring payments to the Service Professional (this fee is referred to as “Fees”). You acknowledge that the final bill you receive may include additional charges, including without limitation, a safety fee, warranty fee, insurance fee, or Service Professional welfare fee.</p>
<p>PROHANDS shall notify you of the applicable Charges, Fees, and payment methods at the time of booking. Generally, you may make payments for Pro Services through credit cards, debit cards, net banking, wallets, UPI or cash upon completion of the Pro Service. We have the right to modify and otherwise restrict the modes of payment available to you. You acknowledge that certain payment methods such as cash upon completion may not always be available to you as a payment method. For the avoidance of doubt, in the event you pay through the method of ‘cash upon completion’, you acknowledge that you will be required to pay both Charges and Fees to the Service Professional.</p>
<p>The Charges and Fees may be payable at the time of making a booking, or upon the completion of the Pro Service, as specified by PROHANDS.</p>
<p>For the avoidance of doubt, please note that the Charges are payable to Service Professionals, and PROHANDS acts as a limited collection agent on behalf of such Service Professionals to collect and transfer amounts due to them.</p>
<p><strong>Taxes:</strong> All Charges and Fees are inclusive of applicable taxes.</p>
<p>PROHANDS reserves the right to reasonably amend the Charges and Fees at any time at its sole discretion. A change in Fees shall not impact any bookings that have been confirmed before the publication of the revised Fees on the Platform.</p>
<p>Charges and Fees that you pay are final and non-refundable, unless otherwise determined by PROHANDS or required by the applicable laws. Under certain laws, you may be entitled to a refund or other remedies for a failure in the provision of the Services.</p>
<p>You acknowledge and agree that Charges and Fees applicable in certain geographical areas may increase substantially during times of high demand. PROHANDS will use reasonable efforts to inform you of the Charges and Fees that may apply. However, by using the Pro Services or Services, you will be responsible for the Charges and Fees incurred under your Account regardless of your awareness of such Charges or Fees.</p>
`;

const professionalContent = `
<p><strong>These Terms and Conditions apply to Service Professionals using the PROHANDS platform.</strong></p>
...
<p>(B) The Terms constitute a binding and enforceable legal contract between PROHANDS LLP (a company incorporated under the Companies Act, 2013 with its registered address at [Insert Registered Office Address] and its corporate office at [Insert Corporate Office Address]) and its affiliates (“PROHANDS”, “PH”, “we”, “us”, or “our”), and you, an independent third-party service provider (“you” or “Service Professional”). By using the Services, you represent and warrant that you have the full legal capacity and authority to agree and bind yourself to these Terms. If you represent any other person, you confirm and represent that you have the necessary power and authority to bind such person to these Terms.</p>
...
<h2>1. SERVICES</h2>
<p>The Services include the provision of the Platform that enables you to provide different home-based services to end-customers registered on the Platform (“Customers”). As a part of the Services, PROHANDS (i) assists you with determining amounts payable by Customers to you for the services you render, (ii) facilitates the maximum and efficient utilisation of your time while you use the Services, (iii) takes measures to maximise your earning potential through your use of the Services, and (iv) facilitates the transfer of payments from Customers to you for the services you render to the Customers and collect payments on your behalf. The Services are made available under various brands owned by or otherwise licensed to PROHANDS or its affiliates.</p>
<p>The services rendered by you are referred to as “Pro Services”. Our “Services” do not include the Pro Services, and PROHANDS is not responsible for the provision of Pro Services. PROHANDS and its affiliates do not employ you or any other Service Professional, nor are Service Professionals the agents, contractors, or partners of PROHANDS or its affiliates. Service Professionals do not have the ability to bind or represent PROHANDS. You are solely liable and responsible for the Pro Services that you offer or otherwise provide through the Platform.</p>
<p>The Platform is solely for your commercial use and is intended for use only within India. A key part of the Services is PROHANDS’s ability to send you text messages, including in connection with your bookings, your utilisation of the Services, or as a part of its promotional and marketing strategies. While you may opt out of receiving these text messages by contacting PROHANDS at contact@prohands.com, you agree and acknowledge that this may impact PROHANDS ability to provide the Services (or a part of the Services) to you.</p>
<p>Prior to the activation of your ability to use certain parts of the Services and provide Pro Services through the Platform, you are required to attend an orientation programme at your local PROHANDS office to enable you to understand amongst other matters (i) how the Platform works, and (ii) means and ways to maximise your earning potential on the Platform. You hereby agree to attend such orientation programme(s). PROHANDS reserves the right to charge a certain non-refundable fee towards your orientation/ onboarding onto the platform at its sole discretion, for certain Pro Services which will be intimated to you in advance. And such fee will be recovered from you in installments from your earnings after you join the platform.</p>
...
<p>You shall, at all times, be required to maintain a minimum balance of credits (“PH Credits”) to be able to access parts of the Services. PH Credits will be credited to your Account against payment being made by you to obtain the PH Credits. You agree and acknowledge that your use of the Services may be affected if you do not have the requisite PH Credits. In addition and notwithstanding anything to the contrary hereunder, PROHANDS reserves the sole discretion to require the payment of additional fees in respect of (A) the provision of Leads in certain market segments or (B) the provision of additional Services.</p>
<p>You are required to deposit a pre-determined amount of PH Credits with PROHANDS (“Pre-Deposit”) in order to be able to accept Leads. The details required to connect you with a Customer will only be communicated to you after the Pre-Deposit is made with PROHANDS. The quantum of the Pre-Deposit will be based on the aggregate value of the Lead(s). Pre-Deposit may be secured as a percentage of the aggregate value of Leads, or as a fixed sum. The quantum of the Pre-Deposit for the particular Pro Services offered by you to the Customer will be communicated to you from time to time, or before the communication of a Lead.</p>
<p>To ensure maintenance of the Pre-Deposit, you acknowledge and authority PROHANDS to deduct certain amounts from the payments made by the Customers to you.</p>
<p>You may also use PH Credits to purchase goods and services offered by PROHANDS to you from time to time.</p>
<p><strong>Promotions, and Subscription Packages:</strong> PROHANDS may, at its sole discretion, issue PH Credits free of charge to your Account, and/or may create promotional codes that may be redeemed for Account credits or other features or benefits related to the Services (“Promo PH Credits”), subject to any additional terms that PROHANDS may impose and share with you from time to time. You agree that Promo PH Credits (A) shall not be duplicated, sold, or transferred in any manner, or made available to any person other than yourself, (B) may be disabled by PROHANDS at any time for any reason without liability to PROHANDS, (C) are not valid for cash, and (D) may expire prior to your use.</p>
<p>Based on factors such as your ratings and reviews by Customers, PROHANDS may, at its sole discretion, from time to time offer (A) subscription packages or scheme (howsoever named) in exchange for PH Credits and/ or (B) minimum business guarantees subject to applicable terms and conditions communicated to prior to acceptance of the minimum guarantee. Upon purchasing such subscription package or scheme or acceptance of minimum business guarantee, you may be entitled to certain benefits such as preferential Leads (i.e., Lead allocation on priority and lower convenience fee deductions), or the job value communicated to you, in lieu of the Leads. Such packages, schemes, and/or guarantees shall be subject to additional terms.</p>
<p>In case you are unable to meet the requirements agreed upon for availing the minimum business guarantee, PROHANDS may on the occurrence of any Customer experience related issues or other conditions, terminate such arrangement. Provided that, PROHANDS shall not be entitled to levy a penalty under Clause 3(d)(iv) if You are unable to meet the requirements due to PROHANDS fault. For clarity, PROHANDS’s fault shall mean (i) outage of Services; (ii) Platform malfunction; or (iii) occurrence of any other event (not attributable to you whether directly or indirectly) causing disruption or failure in the provision of Services.</p>
<p>You hereby acknowledge that PROHANDS offers a minimum business guarantee and subscription packages to improve (A) your access to Leads and (B) the Customer experience of the Services. Nothing in these schemes shall be interpreted to mean that PROHANDS is responsible for the provision of Pro Services.</p>
<p><strong>Performance Based Schemes:</strong> PROHANDS may from time to time introduce schemes for high performing Service Professionals to be allotted preferential Leads (as explained above). The parameters to determine a Service Professional’s performance shall include but not be limited to, service feedback received from Customers, proportion of Leads accepted, and other parameters as may be communicated to you from time to time.</p>
<p>PROHANDS reserves the right to withhold or deduct PH Credits or Promo PH Credits in the event that PROHANDS reasonably determines or believes that the use of the PH Credits or Promo PH Credits was in error, fraudulent, illegal, or in violation of the applicable Promo Code terms or these Terms.</p>

<h2>4. HELPERS</h2>
<p><strong>Helpers or Assistants:</strong> You agree and acknowledge that:</p>
<ul>
<li>You may not engage another person to assist you in the provision of the Pro Services (“Helper”) unless expressly permitted by PROHANDS. You shall be solely liable for all acts and omissions made by the Helper you have engaged. The following terms apply if you choose to appoint a Helper:</li>
  <ul>
    <li>you must provide Pro Services in a category where the engagement of Helpers is permitted by PROHANDS;</li>
    <li>the Helper must be registered on the Platform in their capacity as your Helper. In this regard, PROHANDS shall have the right to demand for documentation governing the applicant’s birth, residency, and any other documents or information that PROHANDS may deem necessary. PROHANDS further reserves the right to carry out a background verification of the Helper, the cost of which verification shall be borne by you;</li>
    ...
    <li>such other terms and conditions prescribed by PROHANDS from time to time.</li>
  </ul>
...
<li>Any breach of these Terms by the Helper shall be considered a breach by you and shall be dealt with accordingly in accordance with these Terms. Further, you shall indemnify and hold harmless PROHANDS and its affiliates and their officers, directors, employees, and agents from any and all claims, demands, losses, liabilities, and expenses (including attorneys’ fees) arising out of, or in connection with, any act or omission by the Helper.</li>
<li>You agree that there is no contract of employment between PROHANDS and the Helper, and that you have engaged the Helper in your capacity as an independent contractor.</li>
<li>You shall be solely liable for compensating the Helper on the terms and conditions agreed upon between you and the Helper. PROHANDS shall not be liable to compensate the Helper for the provision of the Pro Services or any expense incurred or assistance provided by the Helper to you in the provision of the Pro Services. Further, PROHANDS shall not be liable to pay you any extra compensation for engaging a Helper.</li>
</ul>
`;
