...
function Categories() {
  ...
  return (
    <section id="categories" className="border-t border-border/50 py-12 sm:py-16 md:py-20">
...
function Services() {
  return (
    <section id="services" className="relative border-t border-border/50 py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeader
          eyebrow="What we do"
...
function Products() {
  return (
    <section id="products" className="border-t border-border/50 py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeader
...
function Gallery() {
  ...
  return (
    <section id="gallery" className="border-t border-border/50 py-12 sm:py-16 md:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <SectionHeader
...
function Download() {
  return (
    <section id="download" className="relative overflow-hidden py-12 sm:py-16 md:py-20">
      <div
        aria-hidden
...
function Footer() {
  return (
    <footer className="border-t border-border/60 bg-background">
      <div className="mx-auto grid max-w-7xl gap-8 sm:gap-10 px-4 sm:px-6 py-12 md:py-16 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <ul className="mt-3 sm:mt-4 space-y-2.5 sm:space-y-3 text-xs sm:text-sm text-muted-foreground">
            <li className="flex items-center gap-2"><Phone className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary shrink-0" /> +91 97441 46638</li>
            ...
            <li className="flex items-start gap-2"><MapPin className="mt-0.5 h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary shrink-0" /> Kozhikode, Kerala, India</li>
          </ul>
        </div>
